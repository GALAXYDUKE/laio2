...
/**
 * ViewGroup that draws a grid of calendar cells. All children must be {@link CalendarRowView}s. The
 * first row is assumed to be a header and no divider is drawn above it.
 */
