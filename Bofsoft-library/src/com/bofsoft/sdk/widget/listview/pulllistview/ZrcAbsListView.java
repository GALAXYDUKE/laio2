...
import com.bofsoft.sdk.widget.listview.pulllistview.ZrcListView.OnScrollListener;
import com.bofsoft.sdk.widget.listview.pulllistview.ZrcListView.OnScrollStateListener;
import com.bofsoft.sdk.widget.listview.pulllistview.ZrcListView.OnStartListener;
...
public abstract class ZrcAbsListView extends ZrcAdapterView<ListAdapter> implements ViewTreeObserver.OnTouchModeChangeListener {
    ...
    public ZrcAbsListView(Context context) {
        super(context);
        initAbsListView();
        setDefaultHeadler(context);
        setDefaultFooter(context);
    }
...
//        a.recycle();
    ...
    private void setDefaultHeadler(Context context) {
    ...
    private void setDefaultFooter(Context context) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (childCount > 0 && (isRefreshing || isLoadingMore) && footer != null) {
            ...
            if (childCount != mItemCount && firstPosition + childCount == mItemCount) {
...
//                Log.i("", "bottom:"+lastBottom+"   viewBottom:"+viewBottom);
                if (lastBottom < viewBottom) {
                    boolean more = footer.draw(canvas, listPadding.left, lastBottom, getWidth() - listPadding.right, isTooShort ?
                            lastBottom + footer.getHeight() : viewBottom - mLastBottomOffset);
                    if (more) {
...
//    }
    ...
    boolean trackMotionScroll(int deltaY, int incrementalDeltaY) {
        ...
        if (childCount != mItemCount && firstPosition + childCount >= mItemCount - 1) {
    ...
    private class FlingRunnable implements Runnable {
        ...
        boolean scrollToAdjustViewsUpOrDown() {
            ...
            final int bottomOffset = isTooShort ?
                    firstTop - listPadding.top - mFirstTopOffset : lastBottom - getHeight() + listPadding.bottom + mLastBottomOffset;
