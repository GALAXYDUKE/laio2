...
import com.bofsoft.sdk.widget.listview.swipemenulistview.SwipeMenuListView.OnMenuItemClickListener;
import com.bofsoft.sdk.widget.listview.swipemenulistview.SwipeMenuView.OnSwipeItemClickListener;
...
public class SwipeMenuAdapter implements WrapperListAdapter, OnSwipeItemClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            layout =
                    new SwipeMenuLayout(contentView, menuView, listView.getCloseInterpolator(),
