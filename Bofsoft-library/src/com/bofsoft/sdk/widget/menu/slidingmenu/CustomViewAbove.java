...
import com.bofsoft.sdk.widget.menu.slidingmenu.SlidingMenu.OnClosedListener;
import com.bofsoft.sdk.widget.menu.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    public static class SimpleOnPageChangeListener implements OnPageChangeListener {
         ...
         * (non-Javadoc)
         *
         * @see com.ab.view.slidingmenu.CustomViewAbove.OnPageChangeListener#onPageScrolled(int, float,
         * int)
         */
