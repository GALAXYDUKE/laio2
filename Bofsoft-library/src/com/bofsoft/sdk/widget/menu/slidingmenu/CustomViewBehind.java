...
import com.bofsoft.sdk.widget.menu.slidingmenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
    ...
    public CustomViewBehind(Context context, AttributeSet attrs) {
        super(context, attrs);
        mMarginThreshold =
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, MARGIN_THRESHOLD,
