...
import com.bofsoft.laio.customerservice.Fragment.HomeFragment;
...
//		BNDemoMainActivity.activityList.add(this);
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(HomeFragment.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
...
//		BNRouteGuideManager.getInstance().resetEndNodeInNavi(new  BNRoutePlanNode(104.062501,30.610525, "桐梓林一号", null, BNRoutePlanNode.CoordinateType.BD09LL));//该方法从新设置终点
    }
