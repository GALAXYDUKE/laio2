...
import com.bofsoft.laio.customerservice.DataClass.Money.AccountStatusInfoData;
import com.bofsoft.laio.customerservice.R;
import com.bofsoft.laio.customerservice.Tools.DialogUtils;
import com.bofsoft.laio.customerservice.Tools.Utils;
import com.bofsoft.laio.customerservice.Widget.WaitDialog;
...
//        }
    ...
    private void init(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            ConfigallCostomerService.GUID = savedInstanceState.getString("GUID");
            ConfigAll.isLogin = savedInstanceState.getBoolean("isLogin");
            ConfigAll.CodeNum = savedInstanceState.getShort("CodeNum");
            ConfigallCostomerService.Username = savedInstanceState.getString("Username");
            ConfigAll.UserUUID = savedInstanceState.getString("UserUUID");
            ConfigallCostomerService.MasterId = savedInstanceState.getString("MasterId");
            ConfigallCostomerService.MasterJiaxiao = savedInstanceState.getString("MasterJiaxiao");
            ConfigallCostomerService.MasterName = savedInstanceState.getString("MasterName");
            ConfigallCostomerService.MasterShowName = savedInstanceState.getString("MasterShowName");
            ConfigallCostomerService.StatusRenZheng = savedInstanceState.getInt("StatusRenZheng");
            ConfigallCostomerService.StatusEmail = savedInstanceState.getInt("StatusEmail");
            ConfigallCostomerService.StatusRenZhengName = savedInstanceState.getString("StatusRenZhengName");
            ConfigallCostomerService.StatusEmailName = savedInstanceState.getString("StatusEmailName");
            ConfigallCostomerService.Email = savedInstanceState.getString("Email");
            ConfigallCostomerService.IDCardNum = savedInstanceState.getString("IDCardNum");
            ConfigallCostomerService.Name = savedInstanceState.getString("Name");
        }
//         myActivityInfo = new MyActivityInfo();
        ...
        ConfigallCostomerService.screenWidth = display.getWidth();
        ConfigallCostomerService.screenHeight = display.getHeight();
...
//                });
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putCharSequence("GUID", ConfigallCostomerService.GUID);
        outState.putShort("CodeNum", ConfigAll.CodeNum);
        outState.putBoolean("isLogin", ConfigAll.isLogin);
        outState.putCharSequence("Username", ConfigallCostomerService.Username);
        outState.putCharSequence("UserUUID", ConfigAll.UserUUID);
        outState.putCharSequence("MasterId", ConfigallCostomerService.MasterId);
        outState.putCharSequence("MasterJiaxiao", ConfigallCostomerService.MasterJiaxiao);
        outState.putCharSequence("MasterName", ConfigallCostomerService.MasterName);
        outState.putCharSequence("MasterShowName", ConfigallCostomerService.MasterShowName);
        outState.putInt("StatusRenZheng", ConfigallCostomerService.StatusRenZheng);
        outState.putInt("StatusEmail", ConfigallCostomerService.StatusEmail);
        outState.putCharSequence("StatusRenZhengName", ConfigallCostomerService.StatusRenZhengName);
        outState.putCharSequence("StatusEmailName", ConfigallCostomerService.StatusEmailName);
        outState.putCharSequence("Email", ConfigallCostomerService.Email);
        outState.putCharSequence("IDCardNum", ConfigallCostomerService.IDCardNum);
        outState.putCharSequence("Name", ConfigallCostomerService.Name);
        bundle = outState;
...
//            jsonObject.put("ObjectType", ConfigallStu.ObjectType);
    ...
    public void parseAccountStatusInfo(String result) {
        ...
        ConfigallCostomerService.accountStatus = data;
    }
