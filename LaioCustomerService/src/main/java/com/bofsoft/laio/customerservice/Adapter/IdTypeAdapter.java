...
public class IdTypeAdapter extends BaseAdapter {
    ...
    public List<IdTypeData> getmList() {
        return mList;
    }

    public void setmList(List<IdTypeData> mList) {
        this.mList = mList;
    ...
    @Override
    public IdTypeData getItem(int position) {
        if (mList == null) {
            return null;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        IdTypeData data = mList.get(position);
