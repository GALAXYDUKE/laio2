 ...
 * @author yedong
 */
public class StuSourceAdapter extends BaseAdapter {
    Context mContext;
    LayoutInflater mInflater;
    List<StuSourceData> mList;

    public StuSourceAdapter(Context context) {
        this.mContext = context;
        mInflater = LayoutInflater.from(context);
    }

    public List<StuSourceData> getList() {
        return mList;
    }

    public void setList(List<StuSourceData> mList) {
        this.mList = mList;
    ...
    @Override
    public StuSourceData getItem(int position) {
        if (mList == null) {
            return null;
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StuSourceData data = mList.get(position);
