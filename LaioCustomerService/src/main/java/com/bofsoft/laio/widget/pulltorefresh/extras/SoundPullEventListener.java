 ...
 * the License.
 *******************************************************************************/
package com.bofsoft.laio.widget.pulltorefresh.extras;
...
public class SoundPullEventListener<V extends View> implements
    ...
    /**
     * Set the Sounds to be played when a Pull Event happens. You specify which sound plays for which
     * events by calling this method multiple times for each event.
     * <p/>
