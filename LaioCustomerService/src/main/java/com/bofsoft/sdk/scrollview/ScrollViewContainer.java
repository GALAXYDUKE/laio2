...
/**
 * 包含两个ScrollView的容器 更多详解见博客http://blog.csdn.net/zhongkejingwang/article/details/38656929
 *
 * @author chenjing
 */
public class ScrollViewContainer extends RelativeLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isMeasured) {
            ...
            // 如果topView高度小于主容器高度，则以topView为准
            topView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
    ...
    private OnTouchListener bottomViewTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (sv.getScrollY() == 0 && mCurrentViewIndex == 1) {
                canPullDown = true;
                Log.e("", sv.getScrollY() + ":top");
                if (listener != null)
                    listener.isTop(true);
            } else {
                canPullDown = false;
                if (listener != null && state != 0)
